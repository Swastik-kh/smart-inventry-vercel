...
import { 
  MagFormEntry, PurchaseOrderEntry, IssueReportEntry, 
  FirmEntry, QuotationEntry, InventoryItem, Store, StockEntryRequest, 
  DakhilaPratibedanEntry, ReturnEntry, MarmatEntry, DhuliyaunaEntry, LogBookEntry, 
  DakhilaItem 
} from './types/inventoryTypes';
import { RabiesPatient, TBPatient, GarbhawatiPatient, ChildImmunizationRecord } from './types/healthTypes';
...
const DEFAULT_ADMIN: User = {
    ...
    allowedMenus: ['dashboard', 'inventory', 'settings', 'services', 'khop_sewa', 'immunization_tracking', 'reports', 'report_khop']
};
