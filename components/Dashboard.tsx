  ...
  const allMenuItems: MenuItem[] = [
    ...
    { 
      ...
      subItems: [
        ...
        { id: 'khop_sewa', label: 'खोप सेवा (Vaccination Service)', icon: <Baby size={16} /> }, 
    ...
    { 
        ...
        subItems: [
            ...
            { id: 'report_khop', label: 'खोप रिपोर्ट (Immunization Report)', icon: <Baby size={16} /> }, 
