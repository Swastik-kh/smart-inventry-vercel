...
export const PatientSticker: React.FC<PatientStickerProps> = ({ record }) => {
  ...
  return (
    <div className="sticker-print" style={{ width: '4in', height: '2in', padding: '0.1in', border: '1px solid #000', display: 'flex', flexDirection: 'row', alignItems: 'center', gap: '0.1in', fontSize: '12px', fontFamily: 'sans-serif' }}>
      <div style={{ flex: 1 }}>
