  ...
  const handleSaveAccumulated = async (e: React.FormEvent) => {
    ...
    try {
        ...
        const newBalance: LeaveBalance = {
          ...
          ...(existingBalance?.lastAccrualMonth && { lastAccrualMonth: existingBalance.lastAccrualMonth }),
          ...(existingBalance?.lastFiscalYearReset && { lastFiscalYearReset: existingBalance.lastFiscalYearReset })
        };
